  ...
  return (
    <div className="flex flex-col h-full">
      <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 flex-1">
        <h2 className="text-2xl font-bold text-emerald-700 mb-6">Contact Information</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-gray-600">Main Office: +60 3-1234 5678</p>
              <p className="text-gray-600">Customer Support: +60 3-8765 4321</p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-gray-600">General Inquiries: info@nesproperties.com</p>
              <p className="text-gray-600">Support: support@nesproperties.com</p>
            </div>
          </div>
          ...
          <div className="flex space-x-4">
            {[
              ...
              <a 
                key={index}
                href="#"
                className="bg-gray-100 hover:bg-emerald-100 text-emerald-600 p-2 rounded-full transition-colors duration-200"
      ...
      {/* Call to action card */}
      <div className="bg-emerald-50 rounded-xl shadow-md p-6 mt-6 border border-emerald-100">
        <h3 className="text-lg font-semibold text-emerald-700 mb-2">Need Urgent Assistance?</h3>
        <p className="text-gray-600 mb-4">
          Our support team is available to help you with any urgent inquiries.
        </p>
        <a 
          href="tel:+6031234567" 
          className="bg-emerald-600 text-white font-medium py-2 px-4 rounded-lg inline-flex items-center hover:bg-emerald-700 transition duration-200"
        >
