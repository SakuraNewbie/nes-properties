    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">NES Properties</h3>
            <p className="text-gray-400 mb-4">
              Your trusted partner in finding the perfect property. With years of experience and a commitment to excellence.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {propertyTypes.map((type) => (
                <li key={type.to}>
                  <Link to={type.to} className="text-gray-400 hover:text-white transition-colors">
                    {type.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-emerald-500 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">info@nesproperties.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} NES Properties. All rights reserved.
          </p>
